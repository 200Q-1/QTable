...
execute as @s[tag=QT_Crafted,tag=!QT_FireworkRocket] run data modify entity @s Item.tag merge from entity @e[tag=QT_Slot,tag=!QT_Head,distance=..0.001,limit=1] HandItems[0].tag
execute as @s[tag=QT_Crafted,tag=!QT_FireworkRocket] run data modify entity @s Item.tag merge from entity @e[tag=QT_Slot,tag=QT_Head,distance=..0.001,limit=1] ArmorItems[3].tag
