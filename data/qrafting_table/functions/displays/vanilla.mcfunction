...
execute unless data entity @s HandItems[0].tag.CustomModelData run data merge entity @e[tag=QT_grass_path,tag=QT_Target,distance=..0.001,limit=1] {CustomName:'"QT_block"'}
