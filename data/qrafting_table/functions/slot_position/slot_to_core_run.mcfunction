...
execute as @s[tag=QT_lookslot0,tag=QT_LookSlot] run tag @s add QT_getslot0
execute as @s[tag=QT_lookslot0,tag=QT_LookSlot] rotated as @e[tag=QT_Core,distance=..0.001,limit=1] run function qrafting_table:slot_position/core_to_slot
