...
execute as @s[tag=QT_Slot1] positioned ^-0.1875 ^-1 ^0.1875 run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot2] positioned ^ ^-1 ^0.1875 run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot3] positioned ^0.1875 ^-1 ^0.1875 run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot4] positioned ^-0.1875 ^-1 ^ run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot5] positioned ^ ^-1 ^ run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot6] positioned ^0.1875 ^-1 ^ run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot7] positioned ^-0.1875 ^-1 ^-0.1875 run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot8] positioned ^ ^-1 ^-0.1875 run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=QT_Slot9] positioned ^0.1875 ^-1 ^-0.1875 run function qrafting_table:slot_position/slot_to_core_run
execute as @s[tag=!QT_LookSlot] positioned ^ ^ ^ run function qrafting_table:slot_position/slot_to_core_run
