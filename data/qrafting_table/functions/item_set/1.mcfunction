...
execute if data entity @s data.1.Count run data merge entity @e[tag=QT_Det,distance=..0.001,limit=1] {CustomName:'"QT_Mat"',Marker:true,Fire:32767s,HandItems:[],ArmorItems:[]}
execute if data entity @s data.1.Count run data modify entity @e[name="QT_Mat",distance=..0.001,limit=1] HandItems[0] set from entity @s data.1
...
data modify entity @s data.type.1 set from entity @e[name="QT_Mat",distance=..0.001,limit=1] Tags[]
