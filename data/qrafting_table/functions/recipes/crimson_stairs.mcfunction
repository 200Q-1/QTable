...
data modify storage pretty_crafter: recipe.items.2.2 set value {id:"minecraft:crimson_planks"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:crimson_stairs",Count:4b}
