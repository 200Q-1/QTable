...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:iron_nugget"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:iron_ingot",Count:1b}
