...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:leather"}
...
data modify storage pretty_crafter: recipe.items.2.1 set value {id:"minecraft:leather"}
data modify storage pretty_crafter: recipe.items.2.2 set value {id:"minecraft:leather"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:leather_chestplate",Count:1b}
