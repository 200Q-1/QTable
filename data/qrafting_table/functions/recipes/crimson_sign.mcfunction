...
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:crimson_planks"}
data modify storage pretty_crafter: recipe.items.2.1 set value {id:"minecraft:stick"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:crimson_sign",Count:3b}
