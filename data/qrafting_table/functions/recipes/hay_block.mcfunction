...
data modify storage pretty_crafter: recipe.items.1.0 set value {id:"minecraft:wheat"}
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:wheat"}
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:wheat"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:hay_block",Count:1b}
