...
data modify storage pretty_crafter: recipe.items.2.0 set value {id:"minecraft:red_nether_bricks"}
data modify storage pretty_crafter: recipe.items.2.1 set value {id:"minecraft:red_nether_bricks"}
data modify storage pretty_crafter: recipe.items.2.2 set value {id:"minecraft:red_nether_bricks"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:red_nether_brick_stairs",Count:4b}
