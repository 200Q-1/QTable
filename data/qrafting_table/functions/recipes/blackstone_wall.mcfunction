...
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:blackstone"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:blackstone_wall",Count:6b}
