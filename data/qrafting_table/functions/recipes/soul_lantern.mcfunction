...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:soul_torch"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:soul_lantern",Count:1b}
