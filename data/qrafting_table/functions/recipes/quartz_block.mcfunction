#クォーツブロック
data modify storage pretty_crafter: recipe.items.0.0 set value {id:"minecraft:quartz"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:quartz_block",Count:1b}
