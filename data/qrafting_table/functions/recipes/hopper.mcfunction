...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:chest"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:hopper",Count:1b}
