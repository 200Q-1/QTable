...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:prismarine_shard"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:prismarine",Count:1b}
