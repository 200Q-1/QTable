...
data modify storage pretty_crafter: recipe.items.0.1 set value {id:"minecraft:brick"}
data modify storage pretty_crafter: recipe.items.1.0 set value {id:"minecraft:brick"}
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:brick"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:bricks",Count:1b}
