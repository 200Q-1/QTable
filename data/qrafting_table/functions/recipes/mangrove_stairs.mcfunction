...
data modify storage pretty_crafter: recipe.items.2.2 set value {id:"minecraft:mangrove_planks"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:mangrove_stairs",Count:4b}
