...
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:polished_blackstone"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:polished_blackstone_wall",Count:6b}
