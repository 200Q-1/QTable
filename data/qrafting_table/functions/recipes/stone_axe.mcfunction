...
data modify storage pretty_crafter: recipe.items.1.0 set value {id:"#stone_tool_materials"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:stone_axe",Count:1b}
