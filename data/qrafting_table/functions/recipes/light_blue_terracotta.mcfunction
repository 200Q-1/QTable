...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:light_blue_dye"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:light_blue_terracotta",Count:8b}
data modify storage pretty_crafter: recipe.category set value {Name:"QTable",type:"crafting_shaped",category:"building",group:"stained_terracotta"}
