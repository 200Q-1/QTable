...
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:end_stone_bricks"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:end_stone_brick_wall",Count:6b}
