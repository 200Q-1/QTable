...
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:honeycomb"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:beehive",Count:1b}
