...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:stone_pressure_plate"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:detector_rail",Count:6b}
