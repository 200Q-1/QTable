...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:waxed_weathered_copper",Count:b}
data modify storage pretty_crafter: recipe.category set value {Name:"QTable",type:"",category:""}
