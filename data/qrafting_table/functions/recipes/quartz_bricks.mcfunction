...
data modify storage pretty_crafter: recipe.items.0.1 set value {id:"minecraft:quartz_block"}
data modify storage pretty_crafter: recipe.items.1.0 set value {id:"minecraft:quartz_block"}
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:quartz_block"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:quartz_bricks",Count:4b}
