...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:tripwire_hook"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:crossbow",Count:1b}
