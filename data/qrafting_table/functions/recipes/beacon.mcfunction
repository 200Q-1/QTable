...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:nether_star"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:beacon",Count:1b}
