#グロウストーン
data modify storage pretty_crafter: recipe.items.0.0 set value {id:"minecraft:glowstone_dust"}
...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:glowstone_dust"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:glowstone",Count:1b}
