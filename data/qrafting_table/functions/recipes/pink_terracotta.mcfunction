...
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:pink_dye"}
...
data modify storage pretty_crafter: recipe.result set value {id:"minecraft:pink_terracotta",Count:8b}
