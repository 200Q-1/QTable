...
data modify storage pretty_crafter: recipe.items.1.0 set value {id:"minecraft:magenta_wool"}
data modify storage pretty_crafter: recipe.items.1.1 set value {id:"minecraft:magenta_wool"}
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:magenta_wool"}
data modify storage pretty_crafter: recipe.items.2.1 set value {id:"minecraft:stick"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:magenta_banner",Count:1b}
