...
data modify storage pretty_crafter: recipe.items.1.2 set value {id:"minecraft:rabbit_hide"}
data modify storage pretty_crafter: recipe.items.2.0 set value {id:"minecraft:rabbit_hide"}
data modify storage pretty_crafter: recipe.items.2.1 set value {id:"minecraft:rabbit_hide"}
data modify storage pretty_crafter: recipe.items.2.2 set value {id:"minecraft:rabbit_hide"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:bundle",Count:1b}
