...
data modify storage pretty_crafter: recipe.items.0.2 set value {id:"minecraft:redstone"}
...
data modify storage pretty_crafter: recipe.items.2.0 set value {id:"minecraft:redstone"}
data modify storage pretty_crafter: recipe.items.2.1 set value {id:"minecraft:redstone"}
data modify storage pretty_crafter: recipe.items.2.2 set value {id:"minecraft:redstone"}

data modify storage pretty_crafter: recipe.result set value {id:"minecraft:redstone_block",Count:1b}
