...
##############
execute if data entity @s {PickupDelay:1s} positioned ~ ~-0.8 ~ if entity @a[distance=..1] run data merge entity @s {Tags:[],NoGravity:false,PickupDelay:20s,Health:5s,Age:0s}
##############
